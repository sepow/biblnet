...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('tribes_tribe', (
            ...
            ('deleted', orm['tribes.Tribe:deleted']),
            ('tags', orm['tribes.Tribe:tags']),
            ('private', orm['tribes.Tribe:private']),
        ))
        db.send_create_signal('tribes', ['Tribe'])
        
        # Adding model 'Topic'
        db.create_table('tribes_topic', (
            ('id', orm['tribes.Topic:id']),
            ('tribe', orm['tribes.Topic:tribe']),
            ('title', orm['tribes.Topic:title']),
            ('creator', orm['tribes.Topic:creator']),
            ('created', orm['tribes.Topic:created']),
            ('modified', orm['tribes.Topic:modified']),
            ('editet', orm['tribes.Topic:editet']),
            ('body', orm['tribes.Topic:body']),
            ('views', orm['tribes.Topic:views']),
            ('sticky', orm['tribes.Topic:sticky']),
            ('closed', orm['tribes.Topic:closed']),
            ('tags', orm['tribes.Topic:tags']),
        ))
        db.send_create_signal('tribes', ['Topic'])
        
        # Adding model 'TribeMember'
        db.create_table('tribes_tribemember', (
            ('id', orm['tribes.TribeMember:id']),
            ('tribe', orm['tribes.TribeMember:tribe']),
            ('user', orm['tribes.TribeMember:user']),
            ('moderator', orm['tribes.TribeMember:moderator']),
            ('last_visit', orm['tribes.TribeMember:last_visit']),
        ))
        db.send_create_signal('tribes', ['TribeMember'])
        
        # Creating unique_together for [tribe, user] on TribeMember.
        db.create_unique('tribes_tribemember', ['tribe_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tribes_topic')
        
        # Deleting model 'TribeMember'
        db.delete_table('tribes_tribemember')
        
        # Deleting unique_together for [tribe, user] on TribeMember.
        db.delete_unique('tribes_tribemember', ['tribe_id', 'user_id'])
